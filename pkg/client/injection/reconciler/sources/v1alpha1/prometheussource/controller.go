...
import (
	...
	versionedscheme "github.com/inspirit941/eventing-prometheus/pkg/client/clientset/versioned/scheme"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.PrometheusSource"),
	)
